...
function About() {
  return (
    <div className="h-full"> 
            <h1 className="text-black text-2xl font-bold mb-4 ">About Bitcoin</h1>
            <h3 className="text-black text-lg font-bold">What is Bitcoin?</h3>

            <div className="py-4 border border-gray-400 border-x-0 border-t-0">
            ...
            <h1 className="text-black font-bold my-3">Lorem ipsum dolor sit amet</h1>
            <div className="space-y-6 border border-gray-400 border-t-0 border-x-0 py-2.5">
            ...
            <div className="border border-gray-400 border-x-0 border-t-0 pb-4">
                  <h1 className="font-bold text-xl mt-6 mb-4">Already Holding Bitcoin?</h1>
                  <div className="grid  lg:grid-cols-2 gap-4">
                        <div className="flex bg-gradient-to-r from-[#79F1A4] to-[#0E5CAD] p-3 rounded-[8px]">
                              <Image className="w-[90px] h-[90px] xl:w-[128px] xl:h-[128px] rounded-[8px]" src={about1} alt="aboutlogo1"/>
                              <div className="ml-6 xl:text-xl ">
                        ...
                        <div className="flex bg-gradient-to-r from-[#FF9865] to-[#EF3031] p-3 rounded-[8px]">
                              <Image className="w-[90px] h-[90px] xl:w-[128px] xl:h-[128px] rounded-[8px]" src={about2} alt="aboutlogo1"/>
                              <div className="ml-6 xl:text-xl ">
                                    <h1 className="text-white font-bold">Calculate your</h1>
                                    <h1 className="text-white font-bold">Profits</h1>
                                    <div className="bg-white w-fit p-2 flex items-center rounded-[8px] mt-2">
